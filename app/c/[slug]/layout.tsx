        ...
        <div className="left-section-top">
          ...
          <aside className="channel-sidebar">
            ...
            <div className="features-menu">
              ...
              <div className="features-section-title">Triết học</div>
              <FeatureLink href="/direct-challenge">
                <span className="feature-icon"><svg viewBox="0 0 24 24"><path d="M12 2C10 6 6 9 6 14c0 3.3 2.7 6 6 6s6-2.7 6-6c0-1.7-.6-3.2-1.6-4.4C15 11.5 13 12 12 12c0-3 1-7 0-10z"/></svg></span>
