...
| Platform super admin flag + platform orders | ✅ | `User.isSuperAdmin`; `/admin/orders` for focus.camp community-plan payments; manual approve/cancel |
...
| Per-community invoice webhook | ✅ | Settings → Thanh toán; test endpoint trước khi bật; form HĐ chặn QR; SePay/manual approval bắn payload |
