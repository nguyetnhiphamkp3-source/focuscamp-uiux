...
| Discovery featured communities/challenges | ✅ | Community `category` + `featuredOnGlobal`; challenges reuse `featuredOnGlobal`; latest fallback when no featured match |
